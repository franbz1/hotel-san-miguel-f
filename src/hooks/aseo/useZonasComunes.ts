...
export const useZonasComunes = (
  ...
  return {
    ...
    error: query.error?.message || 'Error al cargar las zonas comunes',
...
export const useZonaComun = (id: number, enabled: boolean = true) => {
  ...
  return {
    ...
    isLoading: query.isPending,
    isError: query.isError,
    error: query.error?.message || 'Error al cargar la zona común',
    refetch: query.refetch,
    isSuccess: query.isSuccess,
  };
};
...
export const useZonasRequierenAseo = () => {
  ...
  return {
    ...
    isLoading: query.isPending,
    isError: query.isError,
    error: query.error?.message || 'Error al cargar zonas que requieren aseo',
    refetch: query.refetch,
    isSuccess: query.isSuccess,
  };
};
...
export const useZonasPorPiso = (piso: number, enabled: boolean = true) => {
  ...
  return {
    ...
    isLoading: query.isPending,
    isError: query.isError,
    error: query.error?.message || `Error al cargar zonas del piso ${piso}`,
    refetch: query.refetch,
    isSuccess: query.isSuccess,
  };
};
...
export const useCreateZonaComun = () => {
  ...
  return {
    ...
    error: mutation.error?.message || 'Error al crear la zona común',
...
export const useUpdateZonaComun = () => {
  ...
  return {
    ...
    isError: mutation.isError,
    error: mutation.error?.message || 'Error al actualizar la zona común',
    isSuccess: mutation.isSuccess,
    reset: mutation.reset,
...
export const useDeleteZonaComun = () => {
  ...
  return {
    ...
    isError: mutation.isError,
    error: mutation.error?.message || 'Error al eliminar la zona común',
    isSuccess: mutation.isSuccess,
    reset: mutation.reset,
