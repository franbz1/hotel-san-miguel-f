...
export default function AnalyticsPage() {
  ...
  const [analisisPeriodo, setAnalisisPeriodo] =
    useState<AnalisisPeriodo | null>(null)
              ...
              <Card className='w-full max-w-md'>
                <CardContent className='p-8 text-center'>
                  ...
                  <p className='text-gray-600'>
                    Solo los administradores pueden acceder a las analíticas del
                    sistema.
                  </p>
                </CardContent>
              </Card>
                      ...
                      <div className='flex items-center justify-between'>
                        <div>
                          ...
                          <p className='text-2xl font-bold'>
                            {analisisPeriodo
                              ? formatearMoneda(
                                analisisPeriodo.promedioPorFactura
                              )
                              : '$0'}
                          </p>
                        </div>
                          ...
                          {facturas.map((factura) => (
                            ...
                            >
                              ...
                              <td className='p-2'>
                                ...
                                >
                                  {factura.huesped.nombres}{' '}
                                  {factura.huesped.primer_apellido}
                                </a>
                              </td>
                              <td className='p-2 text-sm text-gray-600'>
                                {factura.huesped.numero_documento}
                              </td>
                              <td className='p-2'>{factura.reserva.estado}</td>
