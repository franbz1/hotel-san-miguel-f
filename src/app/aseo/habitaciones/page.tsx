    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      {showFilters && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Filtra las habitaciones según criterios de aseo
            </CardDescription>
          </CardHeader>
                ...
                <Select 
                  ...
                  onValueChange={(value) => {
                     if (value === 'all') {
                       ...
                       filterByRequiereAseoHoy(value === 'true');
                     }
                   }}
                >
                  <SelectTrigger>
                ...
                <Select 
                  ...
                  onValueChange={(value) => {
                    if (value === 'all') {
                      ...
                      filterByRequiereDesinfeccionHoy(value === 'true');
                    }
                  }}
                >
                  <SelectTrigger>
                ...
                <Select 
                  ...
                  onValueChange={(value) => {
                    if (value === 'all') {
                      ...
                      filterByRequiereRotacionColchones(value === 'true');
                    }
                  }}
                >
                  <SelectTrigger>
                ...
                <Select 
                  ...
                  onValueChange={(value) => {
                    if (value === 'all') {
                      ...
                      filterByUltimoAseoTipo(value as TiposAseo);
                    }
                  }}
                >
                  <SelectTrigger>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-destructive">
              {habitaciones.filter(h => h.requerido_aseo_hoy).length}
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Estado actual de aseo de todas las habitaciones
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
                ...
                <TableBody>
                  {habitaciones.map((habitacion) => (
                    <TableRow key={habitacion.id}>
                      ...
                      <TableCell>
                        <Badge variant={getBadgeVariant(habitacion.estado)}>
                          {habitacion.estado}
                        </Badge>
                      </TableCell>
                      <TableCell>
                        {getAseoStatusBadge(habitacion.requerido_aseo_hoy, 'Aseo')}
                      </TableCell>
                      <TableCell>
                        {getAseoStatusBadge(habitacion.requerido_desinfeccion_hoy, 'Desinfección')}
                      </TableCell>
                      <TableCell>
                        {getAseoStatusBadge(habitacion.requerido_rotacion_colchones, 'Rotación')}
                      </TableCell>
                      <TableCell>
